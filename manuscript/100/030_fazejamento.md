...
Convido você a imaginar um jogo de computador, um restaurante, e na sua frente tem o desafio que é aumentar o faturamento. Por um lado, você receberá clientes, legal, mas isso se souber lidar com os desafios dados por variáveis diversas no seu caminho, como o tempo lá fora, que influenciará clientes a sair das mesas na hora da chuva. Outras variáveis são o tempo de fornecimento dos produtos, qualidade dos produtos, preço que varia segundo o mercado, etc. Por conta deste ambiente estruturado e de um ciclo operacional orientado a objetivos, como gerar maior receita e clientes satisfeitos, nos tornamos líderes da operação, protagonistas, essencialmente envolvidos na missão de resolver a missão, por exemplo aumentando o faturamento jogando pelas regras, ou essencialmente se virando. Assim como no jogo, na vida real, nossa propensão para buscar eficiência, em outras palavras, nos faz mais eficientes, ao mesmo tempo que vítimas da própria eficiência, a partir do contexto que entramos. Se o jogo fosse o hot dog da esquina, não é difícil o envolvimento com o desafio simplesmente guiado pela equação de sobrevivência, que nos leva a fazer o lanche mais rápido, procurar materiais mais baratos, receber mais clientes, essencialmente atendendo a tudo isso de forma mais eficiente. De forma alguma estou sugerindo que nos envolvemos com a vida depois de aprender com os jogos digitais. Apesar que um dia, entre tantas viagens como passageiro de motoristas de aplicativo, encontrei um jovem que fazia as curvas abruptas tipo "90 graus" que parecia que ele havia feito seu treinamento em algum jogo de computador. Se você é das antigas, seria como as viradas do filme Automan ou Tron. 
