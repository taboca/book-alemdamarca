...
* [ , further ] @todo - p1-editing -  In "Parte 1, Fazejamento Potencializado" - December 18th 2024 - Research editing check: Check the reference to the Kolb model, can we call it a model? Perhaps Chatgpt can do that, instead of the actual research. The notion of using ChatGPT to actually check against formal research is a subject which Marcio had reflected and written before within the Book "Escrevendo um Escritor". @refid-20241218-d156ee08-679a-40da-bff4-d9ffe9fff9a5

#######  @done 

* [Auto done]] @todo-index @todo - p1 - In Fazejamento - Join the paragraph "Exceto uma pequena .." with "O que complicou... "
* [Auto done ] @todo-index @todo - p1 - In Fazejamento - Consider a secion title "The user's voice" before the "Hoje, ao vivo, um jovem cliente " ...
* [Auto done] @todo-index @todo - p1 - In Fazejamento - Join the paragraphs "Mas peço uma pausa..." with "Essa percepção, projetada ..."
* [Auto done] @todo-index @todo - p1 - In "Fazejamento" - Add a point after paragraph of "O que complicou .. " with a "in other words" line which asserts that "we think we are reaching out to the market while in fact we are inviting them in to our ears..." rating:5starts. Note: this perfectly connnect with a statement which soon said that "nós criamos as condições..."
...
* [Done, anchored ] @todo - p1 - In "Fazejamento" - Consider to put a title "O jogo" before the section "Convido você a imaginar um jogo... " @refid-20241226-818c6f48-fe1a-4366-9e48-a5990d236b4f

* [Done, anchored] @todo - p1 - In "Fazejamento" - Consider to put a title before the section that starts with "Além do fazer, atrelado aos desafios..." as "Ação e reação". @refid-20241226-b162c2d5-95ce-46dd-8855-c76711bf2e91
...
* [Done, anchored ] @todo - p1 - In "Part 1, Fazejamento" - add a quote from Joseph Schumpeter. @refid-20241218-e17fe485-585b-4f54-bd78-f602480dcf81
...
* [Done , further] @todo - p1 - In "Part 1, Fazejamento" - #fazejamento #citation - Bring more objective content from the book of Fabricio Morini, "Faça Seu Negócio Decolar", identify where and what he says about the notion of "Fazejamento", bring a citation. @refid-20241218-0ab26bfb-4f84-4ab3-ab77-28b91baa1d7d
...
* Ref doc - https://mail.google.com/mail/u/0/#inbox/KtbxLxglsJdfwrFDpXDZZHPqcpDWWZJckg 

* Ref - https://docs.google.com/document/d/1-ymqZkFtjc2uXV9ezW9PXVtowWNM_iVcAHmNo1O1BVw/edit?tab=t.0 

* Ref - Para estruturar o problema, simplificamos a questão como sendo um problema de foco. Com esta lógica, partindo do princípio que a operação investe energia e atenção, consideramos uma situação onde as narrativas do ambiente influenciam o movimento de liderança,  especialmente quando a operação é desprovida de valores próprios (no sentido de princípios guiados por propósito). Neste cenário, o movimento de liderança é enfraquecido, mesmo que sem consciência, especialmente para aqueles que priorizam a operação. Em outras palavras, o fazejamento torna-se um fazejamento potencializado. 
...
<!--
@note-refai @refid-20250307-ad185ca8-5432-4143-b291-78b88d9121aa https://chatgpt.com/share/67cb75ec-84cc-8011-8eda-fdb3c45ec0ec Translation of blockquote 
-->
...
Já a ilustração de Reid Hoffman - fundador da plataforma LinkedIn e renomado investidor do Vale do Silício - descreve um movimento empreendedor como saltar de um penhasco e tentar montar o avião durante a queda. Reid está nos lembrando sobre a importância de aprender rápido (BAER, 2013), sim, mas também sobre a natureza do ambiente que não deixa de lado o botar a mão na massa. 

<!--
@reference
* BAER, Drake. How LinkedIn’s Reid Hoffman jumped off a cliff and built an airplane. Fast Company, 17 maio 2013. Disponível em: https://www.fastcompany.com/3009831/how-linkedins-reid-hoffman-jumped-off-a-cliff-and-built-an-airplane?utm_source=chatgpt.com. Acesso em: 26 nov. 2024.
-->

A nossa propensão ao fazer, como fazer antes do aprender, vem de longa data. Abraham Maslow nos lembra, ao ilustrar o movimento da criança, que nossas aventuras em conhecer o novo acontecem depois de um ambiente de segurança: 

> Mas sabemos também que a curiosidade e a exploração são necessidades 'mais elevadas' do que a segurança, o que significa apenas que a necessidade de se sentir seguro, protegido, sem ansiedade, sem medo, é prepotente, mais forte que a curiosidade. Tanto em macacos quanto em crianças humanas, isso pode ser observado claramente. A criança pequena, em um ambiente estranho, caracteristicamente se agarra à mãe e só então se aventura, pouco a pouco, para explorar coisas e investigar. Se a mãe desaparece e a criança fica assustada, a curiosidade desaparece até que a segurança seja restaurada. Ela explora apenas a partir de um porto seguro.
> (MASLOW, 2011, p. 61, tradução nossa).

<!--
@note @citation original of Maslow 
...
<!--
@references
* Reference - MASLOW, A. H. Toward the Psychology of Being. Connecticut: Martino Publishing, 2011. (Trabalho original publicado em 1962).
-->
...
Como clientes, já passamos por lá, caímos lá, para aquela refeição rápida, antes de voltar para o serviço, para uma reunião com o colega de trabalho, um aniversário, uma conversa boa com amigos, ou para socializar com a galera do serviço, para conhecer alguém, e por ai a vida vai. E se não foram momentos específicos nos estabelecimentos de alimentação, foram nas nossas casas, e na vida, então de longa data estamos vivenciando momentos de alimentação no meio social. Essa vivência, como clientes e consumidores, nos dá uma bela de uma bagagem de experiência sobre o que funciona e o que não funciona. Desta forma, sabemos muito sobre "como funciona esse tipo de operação". E  não podemos ignorar que a própria razão que decidimos nos envolver nessa área é justamente porque "sabemos muito" sobre como funciona esse tipo de operação que casa bem com aquela outras boas razões como "todo mundo tem que comer todo dia".

Pense sobre a quantidade de respostas que temos a partir dessas verdades, desse bom senso, com base nessa experiência sobre o convívio social junto com a alimentação. Em outras palavras, não precisamos consultar os universitários para entender, por exemplo, que o cliente quer o prato limpo e que o ovo não esteja frio. 

<!-- Complication -->

Encaixando as peças, podemos agora considerar como é desafiante estar na posição da operação que precisa resolver a equação. Estar nessa posição onde por um lado o movimento quer fazer acontecer ou "colocar a mão na massa" e por outro o movimento tem respostas porque "sabemos muito sobre o que o cliente quer".  

Então, não é difícil perceber como - guiados também por nosso jeitinho brasileiro acolhedor que tanto gosta de cuidar e que recebe o cliente de forma tão calorosa e que dá ouvidos e carrega empatia na pele - acabamos "nos empreendendo" nos envolvendo com ouvir mais ou menos sal e mais ou menos pimenta e por conta de mais ou menos barato acabamos criando bolinho de nada frito. E como, também pelo cliente e intencionados a resgatar a graça, apelidamos o bolinho à moda proibidão. Ou como, criativamente e mais uma vez por nossos clientes, acabamos "evoluindo" o saudoso pão nosso de queijo de cada dia para um padrão "fit", que desnutrido precisou receber uma boa dose de "soro de leite". E como que, por conta de outro cliente que revoltado disse "pão de quê?", criativamente lançamos a versão recheada, e com quê? Com queijo, é lógico, atendendo a pedidos. E como, mais uma vez ouvindo outro cliente neste caso reclamou do preço salgado, eloquentemente adaptarmos o este delicioso caro recheio de queijo para então, voilá, a versão recheada com a solução "tipo queijo". E como, que mais outra vez ouvindo outro cliente que disse que o "tipo queijo" não é a mesma coisa do "recheado com queijo" encontramos, no posso poço criativo, respostas, cores e sabores. O que não fazemos para alegrar o coração do brasileiro não é mesmo? 
...
Depois de tantas viagens como passageiro de motoristas de aplicativo, já ví de tudo. Mas teve um caso especial que só ví uma vez. O motorista era um jovem, e ele fazia, digamos "curvas fortes". Mas não eram só fortes. Eram curvas quadráticas, ou binárias. Eu posso explicar, ele simplesmente virava "90 graus". Na época do meu pai, ele reclamava do trânsito, dizendo que as pessoas tiravam cartas pelo telefone. Então, naquele dia, o que eu vi, atualizando um pouco, seria a mesma coisa de dizer que tirou carta pelo videogame. Se você é das antigas, eram viradas do tipo autobain ou estilo Tron. 

Não quero dizer ainda que jogos de computador influenciam nossos movimentos. Vire essa boca para lá, Marcio. Mas tem algo que explica por que jogos de computador são legais de jogar, e essa mesma coisa explica um pouco sobre o jogo da vida. 

Convido você a imaginar o jogo do restaurante, e na sua frente tem o desafio que é aumentar o faturamento. Por um lado, você receberá clientes, legal, mas isso se souber lidar com os desafios dados por variáveis diversas no seu caminho, como o tempo lá fora, que influenciará clientes a sair das mesas na hora da chuva. Outras variáveis são o tempo de fornecimento dos produtos, qualidade dos produtos, preço que varia segundo o mercado, etc. Por conta deste ambiente estruturado e de um ciclo operacional orientado a objetivos, como gerar maior receita e clientes satisfeitos, nos tornamos líderes da operação, protagonistas, essencialmente envolvidos na missão de resolver a missão, por exemplo aumentando o faturamento jogando pelas regras, ou essencialmente se virando. 

Nossa propensão para buscar eficiência realmente aparece na hora em que o jogo da vida pede por isso, como no jogo, performance é o que importa. Então, quero concluir que no jogo da vida tem muita dessa coisa de buscar eficiência. E vou além. Que quando nos envolvemos nessa ideia de aumentar sempre a eficiência, nos tornamos vítimas do movimento pela eficiência. Se se no jogo da vida você esbarrar na missão de fazer o hot dog da esquina, não será difícil o envolvimento, esse envolvimento guiado pela equação de sobrevivência: fazer o lanche mais rápido, procurar materiais mais baratos, receber mais clientes. E por aí vai. Vou voltando para a ilustração de Fabrício Morini. Vamos que vamos, meio que patinando, mas nesse modo "casca-grossa", não é mesmo? 
...
<!--
@highlight: Clécios 
p. 33 , rindo muito com o sachê ajuda
-->


E se esse nosso fazer, neste grito heróico que silencia o custo marginal, é um desafio; ainda temos que nos preparar para nossos atos retumbante que resolvem esses mesmos desafios com aquela criatividade e eloquência que justifica a mente brilhante que um dia disse que "o brasileiro precisa ser estudado". 

Quando eu penso em Hot Dog, não a categoria que foi atingida pelo raio gourmetizador, mas aquele outro da esquina, já sei que vou encontrar aquele sachê especial, uma peculiaridade Brasileira. Sobre a experiência do usuário, costumo dizer que é o  sachê que precisa "de ajuda”. Isso porque não existe aquele saudoso corte-e-vinco bem definido. É a partir dessa realidade desafiadora que muitos estabelecimentos foram legais com a gente e resolveram aquele “trabalho-a-ser-feito”. Até o momento, encontrei duas soluções:

A primeira abordagem consiste em um conjunto lanche-cestinha que traz uma tesourinha, daquelas de uso escolar-infantil. Eu particularmente tenho medo de pensar que as crianças poderiam se cortar por conta do que é que o molho vermelho (tipo ketchup) pode se confundir com sangue. O que nos traz a uma outra solução aparentemente mais segura. Esse método e sistema consiste em uma mini guilhotina acoplada no sistema do porta-guardanapo e canudinhos. 

Sempre que me deparo com essa experiência, eu tento dizer para alguém ao lado, ou para os colaboradores, que "ah ,esse é daqueles que precisa de uma ajuda para abrir né?" Dá uma raiva, de ranger os dentes, principalmente se você tentar abrir com os dentes. Um parênteses: Veja pelo lado positivo: Essas marcas fazem um favor ao cliente por conta que saber o que está dentro poderia acabar com a noite. A relação corte-qualidade parece ter correlação positiva. 
...
<!--
@references 
* @reference - BRANDE, D. Wake up and live (Acorde e Viva). BN Publishing, 2014. (Publicado originalmente em 1936).
--> 
...
<!--
@todo
* [ ] @todo-index, @todo - p1 - In "Parte 1, Fazejamento" - Consider, within the section "fornecedores", the case of the salesman pointed by Maslow and referred in the book Slow Down Start-up. @refid-20241219-948770ee-60e3-40ef-806f-57b54986e678
-->
